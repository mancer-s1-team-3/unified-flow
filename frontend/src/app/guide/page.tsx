    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-zinc-800 bg-zinc-900/35 backdrop-blur-sm shadow-2xl shadow-black/30 overflow-hidden">
        <div className="border-b border-zinc-800 px-6 py-6">
          ...
          <h2 className="text-4xl font-black tracking-tight">Guide</h2>
          ...
          {guidePages.map((page) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="font-semibold text-zinc-100 group-hover:text-cyan-300 transition-colors">{page.title}</h3>
                  <p className="mt-2 text-sm text-zinc-400 leading-relaxed">{page.summary}</p>
                </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Link href="/docs" className="inline-flex items-center gap-2 text-zinc-400 hover:text-indigo-400 text-sm font-medium transition-colors">
