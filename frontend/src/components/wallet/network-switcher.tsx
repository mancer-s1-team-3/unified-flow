...
export function NetworkSwitcher({ className = "" }: { className?: string }) {
  ...
  return (
    <div ref={rootRef} className={`relative ${className}`}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-3 w-56 max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/95 shadow-2xl backdrop-blur-xl">
